...
SFTP (data.valg.dk:22)
  ...
  → calculator.py     Pure functions: D'Hondt kredsmandater + Saint-Laguë tillægsmandater approx
...
- `valg/calculator.py` — pure functions, no I/O. `dhondt`, `modified_saint_lague`, `allocate_kredsmandater`, `allocate_seats_total`, `votes_to_gain_seat`, `votes_to_lose_seat`, `constituency_flip_feasibility`, `seat_momentum`
...
- **Kredsmandater (135):** D'Hondt per storkreds. Accurate.
